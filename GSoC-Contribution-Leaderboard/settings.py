"""
Django settings for GSoC-Contribution-Leaderboard project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'GSoC-Contribution-Leaderboard/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'GSoC-Contribution-Leaderboard.wsgi.application'
